...
main_niveau2.py
===============
Démonstration complète du système niveau 2.
Simule 5 analyses successives sur le même appareil pour montrer
la montée en score de risque et le calcul de tendance.
"""
...
OUTPUT_DIR  = "/mnt/user-data/outputs/rxnet_v2"
HISTORY_DIR = "/mnt/user-data/outputs/rxnet_v2/historique"
