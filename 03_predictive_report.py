"""
03_predictive_report.py
=========================
Development/validation script for RxArtifactNet's predictive engine (level 3).
Simulates 8 analyses over 3 months to show progressive risk increase,
temporal prediction, and alert triggering.
...
OUTPUT_DIR  = os.path.join(PROJECT_ROOT, "outputs", "rxnet_v3")
HISTORY_DIR = os.path.join(PROJECT_ROOT, "outputs", "rxnet_v3", "historique")
ALERT_LOG   = os.path.join(PROJECT_ROOT, "outputs", "rxnet_v3", "alertes.json")
